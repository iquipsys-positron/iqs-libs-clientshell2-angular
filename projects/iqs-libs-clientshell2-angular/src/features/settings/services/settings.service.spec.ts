...
import { IqsSettingsService } from './settings.service';
...
describe('[Settings] settings.service', () => {
    ...
    let service: IqsSettingsService;
    ...
    beforeEach(inject([Store, IqsSettingsService, IqsSettingsDataService],
        (
            testStore: Store<SettingsState>,
            settingsService: IqsSettingsService,
